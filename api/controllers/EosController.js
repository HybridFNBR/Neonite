...
module.exports = {
  ...
  oauthv2: function (req, res) {
    ...
    switch (req.body.grant_type) {
      case "password":
        access_token = oauthTokenV2_accessToken(req.body.username.split("@")[0])
        id_token = oauthTokenV1_idToken(req.body.username.split("@")[0])
        refresh_token = oauthv2_refreshToken(req.body.username.split("@")[0], req.body.username.split("@")[0])
        res.json({
          ...
          "expires_in": 7200,
          "expires_at": "9999-12-31T23:59:59.999Z",
          "account_id": req.body.username.split("@")[0],
          "client_id": "ec684b8c687f479fadea3cb2ad83f5c6",
          "application_id": "fghi4567FNFBKFz3E4TROb0bmPS8h1GW",
          "selected_account_id": req.body.username.split("@")[0],
          "merged_accounts": [],
          "acr": "AAL1",
      ...
      default:
        ...
        if (req.body["device_code"] === "device_code") {
          JWTdecode["dn"] = "Neonite";
          JWTdecode["sub"] = "Neonite";
        }
        access_token = oauthTokenV2_accessToken(JWTdecode["dn"])
        id_token = oauthTokenV1_idToken(JWTdecode["dn"])
        refresh_token = oauthv2_refreshToken(JWTdecode["sub"], JWTdecode["dn"])
        res.json({
          "scope": "basic_profile friends_list openid offline_access presence",
          "token_type": "bearer",
          "access_token": access_token,
