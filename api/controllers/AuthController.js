...
module.exports = {
    oauthToken: function(req, res){	
        ...
        let access_token = jsonwebtoken.sign({
			...
			"clsvc": "prod-fn",
			"t": "s",
			"auth_time": 1727824430,
			"ic": true,
			"exp": 9668532724,
			"iat": 1668529124,
			"jti": "1f5964dedeb64e338b2cf9c605b2c793"
		},"PS256",  {keyid:""})	
		...
		let refresh_token = jsonwebtoken.sign({
			...
			"exp": 9668532724,
			"am": "exchange_code",
			"jti": "6802dbc926aa41e3acaa79ab52d1a722",
			"pfpid": "prod-fn"
		  },"PS256",  {keyid:""})
		res.json({
			"access_token": `eg1~${access_token}`,
			"expires_in": 9668532724,
			"expires_at": "9999-12-31T23:59:59.999Z",
			"token_type": "bearer",
			"refresh_token": `eg1~${refresh_token}`,
			"refresh_expires": 9668532724,
			...
			"acr": "urn:epic:loa:aal1",
			"auth_time": "2020-10-01T23:13:50.108Z"
		}).status(200).end();
    },
